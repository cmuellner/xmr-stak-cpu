...
# CFLAGS
general="-O2 -pipe -Wall -Wextra -fuse-linker-plugin"
...
sched="-fmodulo-sched -fmodulo-sched-allow-regmoves -fsched2-use-superblocks -fsched-pressure -fsched-spec-load -fsched-spec-load-dangerous -fsched-stalled-insns=2 -fsched-stalled-insns-dep=100"
